...
import example.com.map.example.com.furtherstudy.MainActivity;
...
public class LoationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mylocation.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent=new Intent(LoationActivity.this,MainActivity.class);
    ...
    private void navigateTo(BDLocation location) {
        if (isFirstLocate) {
            Toast.makeText(this, "您所在的位置: " + location.getAddrStr(), Toast.LENGTH_LONG).show();
            isFirstLocate = false;
        }
